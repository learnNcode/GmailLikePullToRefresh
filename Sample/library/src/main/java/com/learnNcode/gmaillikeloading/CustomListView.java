...
class CustomListView extends ListView implements INotifyClass {
    ...
    public void setEmptyView(View emptyView) {
            ...
            if (emptyView == null) {
                ...
                ((ViewGroup)getParent().getParent()).addView(dummy, 0, params);
            } else {
            ...
            if (deltaY < 0) {
                ...
                if (!component.isRefreshStarted) {
                    ...
                    if (Math.abs(value) > PROGRESS_THRESHOLD) {
                        Log.i("CustomListView", "-------overScrollBy--calling method to show progressbar|" + getFirstVisiblePosition());
                        startLoading();
                    } else {
    ...
    public void getY(int y) {
        if (y > 0) {
            if ((!component.isRefreshStarted) && (getFirstVisiblePosition() == 0)) {
